...
Looking at the number that sprouted and number that were removed for other reasons, this includes the ones that were removed later for intake characteristics that were outliers, that is why some of the percentages are different than previously generated ones, fixed in table. NEED TO UPDATE IN METHODS THAT SOME WERE REMOVED FOR ANALYSIS BECAUSE OF BAD INTAKE DATA
```{r}
...
#calculating percentages of total props for each 
