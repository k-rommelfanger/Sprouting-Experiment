...
removalplotLARA<-totalpropsplot%>%
  ...
  ggtitle("LARA")+
  scale_fill_manual(values=c("Censored"="#001400","experiment end"="#228B22", "dead"="#355E3B","predation"="olivedrab","mold"="#808000","Sprouted"="darkgreen"), labels=c("Censored"="Censored","experiment end"="Experiment End", "dead"="Dead","predation"="Predation","mold"="Mold","Sprouted"="Sprouted"),name="Reason for Removal")
...
removalplotAVGE<-totalpropsplot%>%
  ...
  theme()+
  scale_fill_manual(values=c("Censored"="#001400","dead"="coral4","mold"="darkolivegreen1","Sprouted"="#228B22"), labels=c("Censored"="Censored", "dead"="Dead","mold"="Mold","Sprouted"="Sprouted"),name="Reason for Removal")
...
source walking through different types of survival analysis
...
plotsprout<-ggcuminc(cra, outcome = c("1"))
plotsprout
...
```{r}
#CIF for sprouting
m1 <- crr(Surv(DaysUntilEvent, Fate) ~ Treatment + Mass,
         failcode = "1",
         data = LARAcr)
...
#TreatmentFresh   2.23    0.241   9.32   5.81, 14.9   <0.001     
#TreatmentSalt    1.83    0.232   6.24   3.96, 9.82   <0.001     
#TreatmentSoil    1.24    0.235   3.46   2.18, 5.48   <0.001     
#Mass             0.556   0.277   1.74   1.01, 3.00   0.045  




#CIF for mold
m2<-crr(Surv(DaysUntilEvent, Fate) ~ Treatment + Mass,
         failcode = "2",
         data = LARAcr)
m2
...
#TreatmentSalt    -12.9   0.255   0.00   0.00, 0.00   <0.001     
#TreatmentSoil    -1.56   0.488   0.21   0.08, 0.55   0.001      
#Mass             0.867   0.923   2.38   0.39, 14.5   0.35 
...
plotsprout<-ggcuminc(Acra, outcome = c("1"))
plotsprout
