...
---
This is the clean publication Ready Code
...
#Found some measurements that are likely measured in the wrong units, going to convert to the correct units
AVGE<-AVGE%>%
...
Visualize characteristics of propagules that sprouted and did not sprout see if it looks like there are differences in intake char of those that sprouted or didn't sprout, makes Supplemental Figure 2
```{r}
...
Visualized AVGE holding radL and L constant and generating results for float and not float
...
Plot logistic regression results for LARA, Combine with AVGE results and make figure 5 (mass is held constant across treatments)
```{r}
...
ggsave("OverallProportionPlot.png",
       plot=totalpatchplot,
       width=8,
       height=3,
       units="in",
...
PICK UP HERE NEED TO FIX lubesprout
